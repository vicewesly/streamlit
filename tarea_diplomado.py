...
st.markdown("""
Este análisis ilustra cómo se compone el ingreso bruto de cada sucursal por 
línea de producto. El primer gráfico muestra valores absolutos, 
lo que permite comparar el rendimiento total de cada sucursal. 
El segundo gráfico ilustra la participación relativa de cada línea 
de producto por sucursal, lo que ayuda a determinar el enfoque o 
...
st.markdown("""
### evidencias o hallasgos que se pueden conciderar Claves:
...
5. Correlaciones: Las relaciones identificadas entre variables clave como costo y ganancia proporcionan insights para la optimización de precios y margen.
...
2. Fidelización: Reforzar y expandir el programa de membresía, dadas las diferencias positivas en el comportamiento de compra de los miembros.
...
Dashboard desarrollado por el grupo 42 - Diplomado BD&ML - 2025
</div>
